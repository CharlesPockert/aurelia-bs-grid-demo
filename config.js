System.config({
  ...
  "bundles": {
    "app-bundle": [
      ...
      "github:gooy/aurelia-compiler@0.0.5/index",
      "github:gooy/aurelia-compiler@0.0.5",
      "github:charlespockert/aurelia-bs-grid@0.0.1/pager/pager",
      "github:charlespockert/aurelia-bs-grid@0.0.1/index",
      "github:charlespockert/aurelia-bs-grid@0.0.1/grid/grid-column",
      "github:charlespockert/aurelia-bs-grid@0.0.1/grid/grid",
...
System.config({
  "map": {
    ...
    "charlespockert/aurelia-bs-grid": "github:charlespockert/aurelia-bs-grid@0.0.1",
